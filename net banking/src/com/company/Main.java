...
public class Main {
    ...
    public static void main (String[] args)  throws Exception {
        ...
        File f1 = new File("c:/Users/SAIF/ideaProjects/login_detail.txt");
        f1.createNewFile();
        File f2 = new File("c:/Users/SAIF/ideaProjects/account_detail.txt");
        f2.createNewFile();
        File f3 = new File("c:/Users/SAIF/ideaProjects/account_no.txt");
        f3.createNewFile();
        File f4 = new File("c:/Users/SAIF/ideaProjects/account_userId.txt");
        f4.createNewFile();
